...
export default function Footer() {
  return (
    ...
    >
      ...
      <svg className={`absolute bottom-0`} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100%" height="100%" viewBox="0 0 1600 900">
        <defs>
