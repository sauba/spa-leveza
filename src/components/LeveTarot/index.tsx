...
export default function LeveTarot() {
  return (
    <div className={`
      ...
      <Accordion>
        <AccordionItem indicator key="1" aria-label="O que é o Tarot Terapêutico ?" title={<span style={{ color: '#f0f0f0', fontSize: '20px' }}>O que é o Tarot Terapêutico ?<ArrowCircleDown /></span>} className={`flex justify-center items-center text-3xl xl:text-6xl font-pt-mono`}>
