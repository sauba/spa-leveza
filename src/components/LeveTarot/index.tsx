...
export default function LeveTarot() {
  return (
    <div className={`
      ...
      <Accordion>
        <AccordionItem indicator key="1" aria-label="O que é o Tarot Terapêutico ?" title={<span style={{ color: '#f0f0f0', fontSize: '20px', display: "flex", alignItems: "center", justifyContent: "space-between" }}>O que é o Tarot Terapêutico?<ArrowCircleDown /></span>} className={`text-3xl xl:text-6xl font-pt-mono`}>
        ...
        <AccordionItem indicator key="2" aria-label="Como Experienciar o Tarot Terapêutico ?" title={<span style={{ color: '#f0f0f0', fontSize: '20px', display: "flex", alignItems: "center", justifyContent: "space-between" }}>Como Experienciar o Tarot Terapêutico?<ArrowCircleDown /></span>} className={`text-3xl xl:text-6xl font-pt-mono`} >
          <p className={`px-2 lg:px-20 text-center text-xl 2xl:text-2xl tracking-wider font-pt-mono`}>
        ...
        <AccordionItem indicator key="3" aria-label="Quando Recorrer ao Tarot Terapêutico ?" title={<span style={{ color: '#f0f0f0', fontSize: '20px', display: "flex", alignItems: "center", justifyContent: "space-between" }}>Quando Recorrer ao Tarot Terapêutico?<ArrowCircleDown /></span>} className={`text-3xl xl:text-6xl font-pt-mono`}>
          <p className={`px-2 lg:px-20 text-center text-xl 2xl:text-2xl tracking-wider font-pt-mono`}>
