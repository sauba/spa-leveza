...
export default function LeveTarot() {
  return (
    <div className={`
      ...
      <Accordion>
        <AccordionItem indicator key="1" aria-label="O que é o Tarot Terapêutico ?" title="O que é o Tarot Terapêutico ?" className={`text-2xl xl:text-6xl font-caveat`} >
          <p className={`px-4 lg:px-24 text-center text-3xl 2xl:text-5xl tracking-wider font-bad-script`}>
        ...
        <AccordionItem indicator key="2" aria-label="Como Experienciar o Tarot Terapêutico ?" title="Como Experienciar o Tarot Terapêutico ?" className={`text-2xl xl:text-6xl font-caveat`} >
          <p className={`px-4 lg:px-24 text-center text-3xl 2xl:text-5xl tracking-wider font-bad-script`}>
        ...
        <AccordionItem indicator key="3" aria-label="Quando Recorrer ao Tarot Terapêutico ?" title="Quando Recorrer ao Tarot Terapêutico ?" className={`text-2xl xl:text-6xl font-caveat`}>
          <p className={`px-4 lg:px-24 text-center text-3xl 2xl:text-5xl tracking-wider font-bad-script`}>
