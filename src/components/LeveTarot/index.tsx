...
export default function LeveTarot() {
  return (
    <div className={`
      ...
      <Accordion>
        <AccordionItem indicator key="1" aria-label="O que é o Tarot Terapêutico ?" title={<span style={{ color: '#f0f0f0', fontSize: '32px' }}>O que é o Tarot Terapêutico ?</span>} className={`text-3xl xl:text-6xl font-pt-mono`}>
        ...
        <AccordionItem indicator key="2" aria-label="Como Experienciar o Tarot Terapêutico ?" title={<span style={{ color: '#f0f0f0', fontSize: '32px' }}>Como Experienciar o Tarot Terapêutico ?</span>} className={`text-3xl xl:text-6xl font-pt-mono`} >
          <p className={`px-2 lg:px-20 text-center text-xl 2xl:text-2xl tracking-wider font-pt-mono`}>
        ...
        <AccordionItem indicator key="3" aria-label="Quando Recorrer ao Tarot Terapêutico ?" title={<span style={{ color: '#f0f0f0', fontSize: '32px' }}>Quando Recorrer ao Tarot Terapêutico ?</span>} className={`text-3xl xl:text-6xl font-pt-mono`}>
          <p className={`px-2 lg:px-20 text-center text-xl 2xl:text-2xl tracking-wider font-pt-mono`}>
      ...
      <Link href="/servicos/tarot" className={`w-9/12 rounded-3xl bg-purple-500 text-white text-xl mt-8 px-4 py-2 font-pt-mono`}>Saiba Mais</Link>
    </div>
  )
}