...
export default function LeveTarot() {
  return (
    <div className={`
      ...
      <Accordion>
        <AccordionItem indicator key="1" aria-label="O que é o Tarot Terapêutico ?" title={<span style={{ color: '#f0f0f0' }}>O que é o Tarot Terapêutico ?</span>} className={`text-3xl xl:text-6xl font-pt-mono`}>
        ...
        <AccordionItem indicator key="2" aria-label="Como Experienciar o Tarot Terapêutico ?" title={<span style={{ color: '#f0f0f0' }}>Como Experienciar o Tarot Terapêutico ?</span>} className={`text-3xl xl:text-6xl font-pt-mono`} >
          <p className={`px-2 lg:px-20 text-center text-2xl 2xl:text-3xl tracking-widest font-pt-mono`}>
        ...
        <AccordionItem indicator key="3" aria-label="Quando Recorrer ao Tarot Terapêutico ?" title={<span style={{ color: '#f0f0f0' }}>Quando Recorrer ao Tarot Terapêutico ?</span>} className={`text-3xl xl:text-6xl font-pt-mono`}>
          <p className={`px-2 lg:px-20 text-center text-2xl 2xl:text-3xl tracking-widest font-pt-mono`}>
