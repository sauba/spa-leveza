  ...
  return (
    <div className={`
      ...
      <div className={``}>
        ...
        <p className={`text-center text-2xl lg:text-3xl font-inter px-2 pb-8`}>Tarot, uma sabedoria milenar que podemos aproximar das nossas vidas  através das leituras, também conhecidas como tiragens. Vamos entender juntas.</p>
      </div>

      <KeenSliderAuto />

      <Accordion className="text-zinc-400 rounded-3xl">
        <AccordionItem indicator key="1" aria-label="O que é ?" title={<span style={{ fontSize: '20px', display: "flex", alignItems: "center", justifyContent: "center", gap: 6, backgroundColor: '#ffffff', color: '#A9A9A9', borderRadius: '32px', borderColor: 'white', outline: 'none', padding: '16px', width: '300px', margin: 'auto' }}><ArrowCircleDown />O que é ?</span>} className={`text-3xl xl:text-6xl font-inter`}>
          <p className={`px-2 lg:px-20 text-center text-xl 2xl:text-2xl tracking-wider font-inter text-zinc-100`}>
      ...
      <Link href="/servicos/tarot" className={`w-4/12 rounded-3xl bg-own-blue text-zinc-100 text-xl my-8 p-2 font-inter font-thin`}>Saiba Mais</Link>
    </div>
  )
}