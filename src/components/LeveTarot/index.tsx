...
export default function LeveTarot() {
  return (
    <div className={`
      ...
      <Accordion>
        <AccordionItem indicator key="1" aria-label="O que é o Tarot Terapêutico ?" title={<span style={{ color: '#f0f0f0' }}>O que é o Tarot Terapêutico ?</span>} className={`text-2xl xl:text-6xl font-allura`}>
        ...
        <AccordionItem indicator key="2" aria-label="Como Experienciar o Tarot Terapêutico ?" title={<span style={{ color: '#f0f0f0' }}>Como Experienciar o Tarot Terapêutico ?</span>} className={`text-2xl xl:text-6xl font-allura`} >
          <p className={`px-2 lg:px-20 text-center text-2xl 2xl:text-3xl tracking-widest font-pt-mono`}>
        ...
        <AccordionItem indicator key="3" aria-label="Quando Recorrer ao Tarot Terapêutico ?" title={<span style={{ color: '#f0f0f0' }}>Quando Recorrer ao Tarot Terapêutico ?</span>} className={`text-2xl xl:text-6xl font-allura`}>
          <p className={`px-2 lg:px-20 text-center text-2xl 2xl:text-3xl tracking-widest font-pt-mono`}>
      ...
      <Link href="/servicos/tarot" className={`rounded-3xl bg-purple-500 text-white text-2xl mt-8 px-4 py-2 font-pt-mono`}>Saiba Mais</Link>
    </div>
  )
}